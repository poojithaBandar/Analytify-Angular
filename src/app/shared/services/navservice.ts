...
export class NavService implements OnDestroy {
  ...
  //   },
    ...
    },
    {
      ...
      badgeClass: 'badge badge-sm bg-secondary badge-hide',
      badgeValue: 'new',
      path: 'analytify/datasources/view-connections',
      type: 'link',
      nochild: true,
    },
    {
      title: 'Saved Queries',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" fill="#000000">
              <g>
    ...
    },
    {
      ...
      badgeClass: 'badge badge-sm bg-secondary badge-hide',
      badgeValue: 'new',
      path: 'analytify/sheets-dashboard',
      type: 'link',
      nochild: true,
    },
    {
    ...
    },
    {
      ...
      badgeClass: 'badge badge-sm bg-secondary badge-hide',
      badgeValue: 'new',
      path: 'analytify/transformationList',
      type: 'link',
      nochild: true,
    },
    //component
