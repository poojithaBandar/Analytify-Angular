...
export class WorkbenchService {
  ...
  downloadExcelS3(obj:any){
    const currentUser = localStorage.getItem( 'currentUser' );
    this.accessToken = JSON.parse( currentUser! )['Token'];
    return this.http.post<any>(`${environment.apiUrl}/download_data_preview/`+this.accessToken,obj);
  }
...
deleteUser(id:any){
  ...
  //image convert
    ...
    promptDetect(obj:any){
      const currentUser = localStorage.getItem( 'currentUser' );
      this.accessToken = JSON.parse( currentUser! )['Token'];
      return this.http.post<any>(`${environment.apiUrl}/prompt_detect/`+this.accessToken,obj);
    }
