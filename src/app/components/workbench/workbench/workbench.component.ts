...
skeletons = Array(6); // show 3 skeleton cards while loading
  ...
  google_analytics: { type: 'image', value: './assets/images/icons_new/GOOGLE_ANALYTICS.svg' },
  ...
  google_sheets: { type: 'image', value: './assets/images/icons_new/GOOGLE_SHEETS.svg' },
